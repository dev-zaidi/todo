...
import { MdDelete, MdDeleteOutline, MdFileDownloadDone } from "react-icons/md";
  ...
  return (
    <div className='container text-center p-2'>
      ...
      <Input
        ...
        value={task.title}
      />
      <Button color='green' backgroundColor="transparent" icon={<IoIosAdd />} handleFunction={handleSubmit} />
      </div>
      <div className={styles.todoBody}>
